...
import ProcPayIconBig from '../../assets/ProcPayIcon-big.png';

const ItemStatusPage4 = () => {
  return (
    <>
      <Navbar/>
        ...
        <img src={ProcPayIconBig} alt='PaidIcon' className='sp-stat-icon-wd'/>
      <Footer/>
    </>
  );
};

export default ItemStatusPage4;